...
// ⚠️ PLACEHOLDER — reemplazar por el WhatsApp real de Blindex (formato
// internacional, sin "+" ni espacios).
const WHATSAPP_NUMBER = "5491100000000";
const WHATSAPP_MSG = "Hola, los contacto desde la web de Blindex.";
...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded-lg bg-ink px-3 py-1.5 text-xs font-medium text-white opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100 md:block">
